...
public class EmpleadoDAOMysqlImpl implements iEmpleadoDAO {
	...
	@Override
	public void update(Empleado dni) throws Exception {
		// actualizo el empleado  con los datos modificados 
		...
		//2 - arma el statement
		 ...
		 statement.setString(1,dni.getNombre());
	     statement.setString(2,dni.getApellido());
		 statement.setLong(3,dni.getDpto_id());
		 statement.setLong(4,dni.getDni());
