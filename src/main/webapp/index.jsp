...
<html lang="es">
	...
	<!--  bg-ligth-->
	  <div class="container bg-ligth" style="height:100vh;">
		 ...
		 <h4 class="mt-2 mb-2 text-left">Full Stack Java</h4 >
		 <h6 class="mt-2 mb-2 text-left">Comision 23061 Profesora Gisele M. Gonzales</h6>
		 <h6 class="mt-2 mb-2 text-left">Alumna: Graciela Dietz</h6 >
		 <!--   
